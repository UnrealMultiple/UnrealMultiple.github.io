...
<span class="line"><span style="color:#DCDCAA;">/moonstyle</span><span style="color:#B5CEA8;"> 4</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10)]))}const c=n(p,[["render",i],["__file","WorldModify.html.vue"]]),r=JSON.parse('{"path":"/en/guide/WorldModify.html","title":"简易的世界修改器","lang":"en-US","frontmatter":{"description":"简易的世界修改器 权限 普通用户使用需分配权限 /moonphase，/moonstyle，切换 月相和月亮样式 指令 8种月相：满月、亏凸月、下弦、残月、新月、娥眉月、上弦月、盈凸月； 9种月亮样式：正常的、火星样式、土星样式、秘银风格、明亮的偏蓝白色、绿色、糖果、金星样式 和 紫色的三重月亮；","head":[["link",{"rel":"alternate","hreflang":"zh-cn","href":"http://docs.terraria.ink/zh/guide/WorldModify.html"}],["meta",{"property":"og:url","content":"http://docs.terraria.ink/en/guide/WorldModify.html"}],["meta",{"property":"og:site_name","content":"TShock Chinese Plugin Repo"}],["meta",{"property":"og:title","content":"简易的世界修改器"}],["meta",{"property":"og:description","content":"简易的世界修改器 权限 普通用户使用需分配权限 /moonphase，/moonstyle，切换 月相和月亮样式 指令 8种月相：满月、亏凸月、下弦、残月、新月、娥眉月、上弦月、盈凸月； 9种月亮样式：正常的、火星样式、土星样式、秘银风格、明亮的偏蓝白色、绿色、糖果、金星样式 和 紫色的三重月亮；"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:locale:alternate","content":"zh-CN"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"简易的世界修改器\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"]]},"headers":[{"level":2,"title":"权限","slug":"权限","link":"#权限","children":[]},{"level":2,"title":"/moonphase，/moonstyle，切换 月相和月亮样式 指令","slug":"moonphase-moonstyle-切换-月相和月亮样式-指令","link":"#moonphase-moonstyle-切换-月相和月亮样式-指令","children":[]}],"git":{},"autoDesc":true,"filePathRelative":"en/guide/WorldModify.md"}');export{c as comp,r as data};
