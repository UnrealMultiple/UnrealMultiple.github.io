import{_ as s,e as a,f as e,o as l}from"./app-C4sI14Ux.js";const i={};function t(p,n){return l(),a("div",null,n[0]||(n[0]=[e(`<h1 id="autopluginmanager-自动更新插件" tabindex="-1"><a class="header-anchor" href="#autopluginmanager-自动更新插件"><span>AutoPluginManager 自动更新插件</span></a></h1><ul><li>作者: 少司命，Cai，LaoSparrow</li><li>出处: 本仓库</li><li>使用指令自动更新服务器的插件(仅本仓库)</li><li>提供了热重载插件的可能，但此热重载并不算是真正意义上的热重载，已加载的程序集无法卸载，而是依然存在于应用域<br> 中，只是不再生效!</li></ul><h2 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h2><table><thead><tr><th>语法</th><th style="text-align:center;">权限</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td>/apm -c</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">检查插件更新</td></tr><tr><td>/apm -u [插件名]</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">一键升级插件，需要重启服务器，插件名可多选<code>英文逗号隔开</code></td></tr><tr><td>/apm -l</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">查看仓库插件列表</td></tr><tr><td>/apm -i [插件序号]</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">安装插件，需重启服务器，插件序号多选<code>英文逗号隔开</code>配合<code>/apm -i</code>指令使用</td></tr><tr><td>/apm -b [插件名]</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">将插件排除更新</td></tr><tr><td>/apm -r</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">检查重复安装的插件</td></tr><tr><td>/apm -rb [插件名]</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">移除排除更新</td></tr><tr><td>/apm -lb</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">列出排除更新的插件</td></tr><tr><td>/apm -il</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">列出已安装插件列表与启用状态</td></tr><tr><td>/apm -on [序号]</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">启用某个插件</td></tr><tr><td>/apm -off [序号]</td><td style="text-align:center;">AutoUpdatePlugin</td><td style="text-align:center;">关闭某个插件</td></tr></tbody></table><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><blockquote><p>配置文件位置：tshock/AutoPluginManager.json</p></blockquote><div class="language-json5 line-numbers-mode" data-highlighter="shiki" data-ext="json5" style="background-color:#fff;color:#24292e;"><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#24292E;">{</span></span>
<span class="line"><span style="color:#032F62;">  &quot;允许自动更新插件&quot;</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">false</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#032F62;">  &quot;插件排除列表&quot;</span><span style="color:#24292E;">: [],</span></span>
<span class="line"><span style="color:#032F62;">  &quot;热重载升级插件&quot;</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">true</span><span style="color:#24292E;">,</span></span>
<span class="line"><span style="color:#032F62;">  &quot;热重载出错时继续&quot;</span><span style="color:#24292E;">: </span><span style="color:#005CC5;">true</span></span>
...
<span class="line"><span>修复apm il指令可能出现的报错</span></span>
<span class="line"><span>v2.0.3.5</span></span>
<span class="line"><span>当系统语言为空时使用 en-US 作为默认语言</span></span>
<span class="line"><span>当 Manifest 无对应语言 Description 时使用 zh-CN 的 Description</span></span>
<span class="line"><span>\`apm -l\` 将作者名与插件描述交换位置, 上色</span></span>
<span class="line"><span>v2.0.3.3</span></span>
