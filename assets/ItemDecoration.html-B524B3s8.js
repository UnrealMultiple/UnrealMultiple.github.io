import{_ as n,c as a,a as l,o as e}from"./app-0Q1DnpH9.js";const o={};function p(i,s){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="itemdeco-手持物品显示" tabindex="-1"><a class="header-anchor" href="#itemdeco-手持物品显示"><span>ItemDeco 手持物品显示</span></a></h1><ul><li>作者: FrankV22</li><li>出处: <a href="https://github.com/itsFrankV22/ItemsDeco-Plugin" target="_blank" rel="noopener noreferrer">Github</a></li><li>显示物品名称：当玩家切换持有的物品时，该物品的名称会以浮动消息的形式出现在玩家头顶，并在聊天中显示。此功能还支持显示伤害值，并可通过配置文件启用或禁用。</li><li>颜色自定义：浮动消息的颜色默认为白色（RGB 值为 255,255,255），可以自定义</li><li>兼容 <a href="https://github.com/itsFrankV22/FloatingText-Chat" target="_blank" rel="noopener noreferrer">Floating-MessageChat</a></li></ul><h2 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="background-color:#1E1E1E;color:#D4D4D4;"><pre class="shiki dark-plus vp-code"><code><span class="line"><span>暂无</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><blockquote><p>配置文件路径：tshock/ItemDecoration.zh-CN.json</p></blockquote><div class="language-json5 line-numbers-mode" data-highlighter="shiki" data-ext="json5" data-title="json5" style="background-color:#1E1E1E;color:#D4D4D4;"><pre class="shiki dark-plus vp-code"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
