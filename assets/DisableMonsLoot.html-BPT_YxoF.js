import{_ as n,c as a,a as l,o as e}from"./app-BIPCnSct.js";const i={};function p(t,s){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="disablemonsloot-禁怪物掉落" tabindex="-1"><a class="header-anchor" href="#disablemonsloot-禁怪物掉落"><span>DisableMonsLoot 禁怪物掉落</span></a></h1><ul><li>作者: 羽学</li><li>出处: <a href="https://gitee.com/Crafty/bean-points" target="_blank" rel="noopener noreferrer">github</a></li><li>魔改&lt;怪物不掉钱插件&gt;开发初衷于配合随机掉落物品开荒用</li><li>此插件通过怪物死亡事件清理当前进度的物品，</li><li>如击败【怪物ID】任意一个怪物则自动关闭【清理功能】</li><li>如果开启了【是否全杀】，则需要击败【怪物ID】所有怪物才会自动关闭</li><li>输入/kdm reset可将所有【清理】开关全部开启，以便重置服务器时还原</li></ul><h2 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h2><table><thead><tr><th>语法</th><th style="text-align:center;">权限</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td>/kdm</td><td style="text-align:center;">killitem.admin</td><td style="text-align:center;">查看禁怪掉落指令菜单</td></tr></tbody></table><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><blockquote><p>配置文件位置：tshock/禁怪物掉落.json</p></blockquote><div class="language-json5 line-numbers-mode" data-highlighter="shiki" data-ext="json5" data-title="json5" style="background-color:#1E1E1E;color:#D4D4D4;"><pre class="shiki dark-plus vp-code"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
<span class="line"><span style="color:#CE9178;">  &quot;使用说明&quot;</span><span style="color:#D4D4D4;">: </span><span style="color:#CE9178;">&quot;你只管改‘ID’就行，‘清理’和‘怪物名’不用动，击杀其中1个怪物ID自动关闭清理功能。指令：/kdm (权限killitem.admin)&quot;</span><span style="color:#D4D4D4;">,</span></span>
...
<span class="line"><span style="color:#CE9178;">  &quot;是否全杀&quot;</span><span style="color:#D4D4D4;">: </span><span style="color:#569CD6;">false</span><span style="color:#D4D4D4;">,</span></span>
<span class="line"><span style="color:#CE9178;">  &quot;清理范围&quot;</span><span style="color:#D4D4D4;">: 35,</span></span>
<span class="line"><span style="color:#CE9178;">  &quot;清理列表&quot;</span><span style="color:#D4D4D4;">: [</span></span>
<span class="line"><span style="color:#D4D4D4;">    {</span></span>
<span class="line"><span style="color:#CE9178;">      &quot;怪物名&quot;</span><span style="color:#D4D4D4;">: </span><span style="color:#CE9178;">&quot;蓝史莱姆, 恶魔眼, 僵尸&quot;</span><span style="color:#D4D4D4;">,</span></span>
<span class="line"><span style="color:#CE9178;">      &quot;清理&quot;</span><span style="color:#D4D4D4;">: </span><span style="color:#569CD6;">true</span><span style="color:#D4D4D4;">,</span></span>
...
<span class="line"><span style="color:#D4D4D4;">        71,</span></span>
<span class="line"><span style="color:#D4D4D4;">        72,</span></span>
<span class="line"><span style="color:#D4D4D4;">        73,</span></span>
<span class="line"><span style="color:#D4D4D4;">        74</span></span>
<span class="line"><span style="color:#D4D4D4;">      ]</span></span>
<span class="line"><span style="color:#D4D4D4;">    }</span></span>
<span class="line"><span style="color:#D4D4D4;">  ]</span></span>
