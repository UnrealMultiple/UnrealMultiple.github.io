import{_ as n,c as a,a as l,o as e}from"./app-0Q1DnpH9.js";const p={};function t(o,s){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="progressbag-进度礼包" tabindex="-1"><a class="header-anchor" href="#progressbag-进度礼包"><span>ProgressBag 进度礼包</span></a></h1><ul><li>作者: 少司命</li><li>出处: 无</li><li>每当完成一个进度时可以领取一个礼包</li></ul><h2 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h2><table><thead><tr><th>语法</th><th style="text-align:center;">权限</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td>/bag r [礼包名称]</td><td style="text-align:center;">bag.use</td><td style="text-align:center;">领取礼包</td></tr><tr><td>/bag rall</td><td style="text-align:center;">bag.use</td><td style="text-align:center;">领取所有可领取礼包</td></tr><tr><td>/bag list</td><td style="text-align:center;">bag.use</td><td style="text-align:center;">查看礼包列表</td></tr><tr><td>/bag reset</td><td style="text-align:center;">bag.admin</td><td style="text-align:center;">重置领取礼包</td></tr></tbody></table><h2 id="具体进度请查看-progresstype-cs-文件" tabindex="-1"><a class="header-anchor" href="#具体进度请查看-progresstype-cs-文件"><span>具体进度请查看 ProgressType.cs 文件</span></a></h2><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><blockquote><p>配置文件位置：tshock/进度礼包.json</p></blockquote><div class="language-json5 line-numbers-mode" data-highlighter="shiki" data-ext="json5" data-title="json5" style="background-color:#1E1E1E;color:#D4D4D4;"><pre class="shiki dark-plus vp-code"><code><span class="line"><span style="color:#D4D4D4;">{</span></span>
