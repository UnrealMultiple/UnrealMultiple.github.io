import{_ as n,a,b as l,o as e}from"./app-BhlGNrBw.js";const i={};function p(o,s){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="criticalhit-打击文字提示" tabindex="-1"><a class="header-anchor" href="#criticalhit-打击文字提示"><span>CriticalHit 打击文字提示</span></a></h1><ul><li>作者: White,Stone·Free，肝帝熙恩</li><li>出处: TShock官方群聊</li><li>在攻击NPC如果产生暴击，会弹出特殊的浮动文字（和伤害数字一样）</li><li>根据武器类型不同产生不同文字</li><li>可以设置即使不暴击也产生文字</li></ul><h2 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="background-color:#fff;color:#24292e;"><pre class="shiki github-light vp-code"><code><span class="line"><span>暂无</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><blockquote><p>配置文件位置：tshock/CriticalConfig.json</p></blockquote><div class="language-json5 line-numbers-mode" data-highlighter="shiki" data-ext="json5" data-title="json5" style="background-color:#fff;color:#24292e;"><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#24292E;">{</span></span>
