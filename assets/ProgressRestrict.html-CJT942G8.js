import{_ as n,e as a,f as l,o as p}from"./app-Dq6ZWzEe.js";const o={};function e(t,s){return p(),a("div",null,s[0]||(s[0]=[l(`<h1 id="progressrestrict-超进度检测" tabindex="-1"><a class="header-anchor" href="#progressrestrict-超进度检测"><span>ProgressRestrict 超进度检测</span></a></h1><ul><li>作者: 少司命 &amp; 恋恋魔改三合一</li><li>出处: github</li><li>超进度检测</li><li>可对物品，弹幕，buff 进行超进度检测</li></ul><div class="hint-container note"><p class="hint-container-title">注</p><p>需要安装前置插件：DataSync(本仓库)</p></div><h2 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h2><table><thead><tr><th>语法</th><th style="text-align:center;">权限</th><th style="text-align:center;">说明</th></tr></thead><tbody><tr><td>空</td><td style="text-align:center;">progress.item.white</td><td style="text-align:center;">超进度物品检查白名权限</td></tr><tr><td>空</td><td style="text-align:center;">progress.projecttile.white</td><td style="text-align:center;">超进度弹幕检查白名权限</td></tr><tr><td>空</td><td style="text-align:center;">progress.buff.white</td><td style="text-align:center;">超进度 Buff 检查白名权限</td></tr></tbody></table><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><blockquote><p>配置文件位置：tshock/超进度检测.json</p></blockquote><div class="language-json5 line-numbers-mode" data-highlighter="shiki" data-ext="json5" style="background-color:#fff;color:#24292e;"><pre class="shiki github-light vp-code"><code><span class="line"><span style="color:#24292E;">{</span></span>
